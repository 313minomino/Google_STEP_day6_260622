...
## 感想
- 旅行好きなので、〇日で行きたい観光地と宿泊場所をどういう経路で辿るかを考えることが多く、この問題は身近な上に興味も沸いた。
- 今まで自分の直感で考えていたことを、説明できるようにして、コードに落とし込むのは面白かった。
- どこでどう重みをつけるかを判断することと、何を重視して何を切り捨てるかを考えるのが難しかった。←適当に数字を当てはめずに、しっかり計算させたら最適な重みを発見することはできそう。
- コードを改良しているのに数字が全然よくならなくて悲しかった。独自のヒューリスティックを考えることは難しかった。が、楽しかった。
- このヒューリスティックをもう少し改善させてみたい。もう少ししっかりやれば研究になりそうだとも思った。私の研究分野とは全く別だが...というか調べたらこういうヒューリスティックを研究した論文とかありそうだなと思った。
